...
- Si ha usado `docopt_c` para realizar la gestión de las opciones y argumentos del programa `vad`, inserte
  ...
  Se ha usado `docopt_c` para que poder pasar el valor de alpha0 y, si no se llena el campo, se ponga un 5 por defetco. A continuación se adjunta una captura con el mensaje de ayuda del programa:
